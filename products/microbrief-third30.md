...
# MicroBrief - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Brief the two-hour tasks too: the outcome, the steps, and the line between done and gold-plating. The product is a local-first Chrome extension: micro task records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active micro tasks; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38802._
...
- Canonical 297-map entry: feature #86 (Pro plan).
...
1. Click the **MicroBrief** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
MicroBrief today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
