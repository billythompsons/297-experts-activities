...
- Canonical 297-map entry: feature #47 (Pro plan).
...
1. Click the **Action Board** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Action Board today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
