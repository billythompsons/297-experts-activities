...
# CommercePulse - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

The sales pulse: completed-minus-refunded net revenue (failed never counts), window comparison with honest deltas (no baseline = null, never +inf%).

_Freemius store product #38353._
...
2. In the left sidebar, click **CommercePulse**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Record order** - work top to bottom.
...
CommercePulse today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
