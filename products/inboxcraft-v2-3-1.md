...
# InboxCraft — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Shared inquiry inbox with assignment, SLA clocks, collision presence, and internal notes.

_Freemius store product #38443._
...
- Automated suite: 18 passed, 0 failed.
...
2. In the left sidebar, click **InboxCraft**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
InboxCraft — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
