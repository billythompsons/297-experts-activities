...
# Citation Desk - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

A reference desk for your sources: capture, format, and verify citations before they embarrass you. The product is a local-first Chrome extension: citation records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 15 active citations; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38600._
...
verified against the source: this build proves it in code (8 readiness points, suite-verified); web source has access date: this build proves it in code (6 readiness points, suite-verified); complete author list: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #191 (Studio plan).
...
1. Click the **Citation Desk** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Citation Desk today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
