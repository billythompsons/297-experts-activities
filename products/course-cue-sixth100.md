...
# Course Cue - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Stay enrolled in your own course: next lesson, streak, stuck point, and the nudge that gets you back. The product is a local-first Chrome extension: course records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 3 active courses; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38632._
...
stuck point named: this build proves it in code (8 readiness points, suite-verified); studied this week: this build proves it in code (6 readiness points, suite-verified); halfway or further: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #29 (Starter plan).
...
1. Click the **Course Cue** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Course Cue today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
