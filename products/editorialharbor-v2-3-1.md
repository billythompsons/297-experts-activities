...
# EditorialHarbor - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Editorial planning and approvals: a staged pipeline from idea to published, with assignees, due dates, a 14-day calendar, and workload view.

_Freemius store product #38385._
...
2. In the left sidebar, click **Editorialharbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
EditorialHarbor today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
