...
# MediaSculpt - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Media optimization and responsive assets: rendition planning that never upscales, AVIF/WebP/JPEG format negotiation, srcset generation, page byte budgets, and coverage audits.

_Freemius store product #38472._
...
2. In the left sidebar, click **MediaSculpt**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Settings, Register asset, Rendition plans**. The records table's key columns: Asset, Source, Plan, srcset.
...
MediaSculpt today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
