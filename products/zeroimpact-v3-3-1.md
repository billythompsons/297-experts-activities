...
# ZeroImpact - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Sustainability operations: per-page weight audits with a stated CO2 model, review-first improvement notes, and verification that only passes when a later audit proves the page got lighter.

_Freemius store product #38562._

## What it replaces

- [Website Carbon Calculator](https://wordpress.org/plugins/website-carbon-calculator/)
- [GreenMetrics](https://wordpress.org/plugins/greenmetrics/)
- [GreenAudit](https://wordpress.org/plugins/greenaudit/)
- [CarbonFooter](https://wordpress.org/plugins/carbonfooter/)

## The wedge (why ours wins)

Every page carries an audit history, so change is measured - lighter and heavier both show up, and heavier is flagged red; Improvements are review-first: a second person approves the plan, and verification requires a second audit that actually got lighter; The site footprint sums real per-page measurements, with an explicit green-hosting discount - the model is stated, not hidden

## What it does today

- Automated suite: 28/28 checks, all green.
...
2. In the left sidebar, click **ZeroImpact**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **CO2 / full-page view, Pages audited** - read them left to right for the state of things.
4. The main sections are **Pages, Improvement notes, Audit a page, Improvement note**. The records table's key columns: Page, Latest weight, CO2/view, Change, Audits.
...
ZeroImpact today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
