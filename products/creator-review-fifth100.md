...
# Creator Review - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Review a creator before you sponsor them: audience fit, real engagement, and the price sanity check. The product is a local-first Chrome extension: creator records with 10 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active creators; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38633._
...
- Canonical 297-map entry: feature #204 (Studio plan).
...
1. Click the **Creator Review** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Creator Review today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
