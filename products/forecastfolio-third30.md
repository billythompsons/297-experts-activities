...
lesson extracted: this build proves it in code (8 readiness points, suite-verified); resolved cleanly: this build proves it in code (6 readiness points, suite-verified); real reasoning: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #214 (Studio plan).
...
1. Click the **ForecastFolio** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
ForecastFolio today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
