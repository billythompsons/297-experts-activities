...
# CookieCompass - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Cookie and embedded-content inventory: scans your front page, classifies every cookie and third-party host by purpose, and tracks consent remediation evidence.

_Freemius store product #38370._
...
2. In the left sidebar, click **Cookiecompass**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
CookieCompass today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
