...
# ProCurepath - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Procurement request intake, supplier comparison, and approval-controlled purchase planning - no approval without a chosen quote, no self-approvals, over-budget needs a written note.

_Freemius store product #38500._
...
2. In the left sidebar, click **ProcurePath**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New request** - work top to bottom.
...
ProCurepath today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
