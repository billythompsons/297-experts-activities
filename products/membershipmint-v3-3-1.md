...
# MemberShipmint - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Membership plan records, entitlement review, and renewal operations: grandfathered pricing, entitlement drift flags, and per-member effective entitlement lists.

_Freemius store product #38475._
...
2. In the left sidebar, click **MembershipMint**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Plans, New plan, Members, Actions**. The records table's key columns: Members, Plan, Entitlements, List price, Member.
...
MemberShipmint today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
