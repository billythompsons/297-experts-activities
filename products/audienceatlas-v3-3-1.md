...
# AudienceAtlas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Local audience segmentation from data you already have: new-30d, commenters, voices (5+ comments), dormant-90d, staff - segment sizes, role mix, engagement rate. No tracking, no external service.

_Freemius store product #38331._
...
2. In the left sidebar, click **AudienceAtlas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Segments, Roles**. The records table's key columns: Segment, Meaning, Users.
...
AudienceAtlas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
