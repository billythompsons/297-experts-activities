...
# Spec Compare - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Compare two spec versions line by line: what changed, what it breaks, and who must sign off. The product is a local-first Chrome extension: spec diff records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active spec diffs; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38831._
...
- Canonical 297-map entry: feature #266 (Studio plan).
...
1. Click the **Spec Compare** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Spec Compare today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
