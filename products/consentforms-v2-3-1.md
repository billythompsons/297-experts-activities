...
# ConsentForms - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Opt-in consent forms with tamper-evident records: statements min 20 chars, editing the statement bumps the version (old consent stops being current), identical same-version records refused, required forms refuse decline-as-acceptance. [consentform slug="newsletter-opt-in"].

_Freemius store product #38359._
...
2. In the left sidebar, click **ConsentForms**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New form**. The records table's key columns: Form, Version, Required, Records, Edit statement.
...
ConsentForms today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
