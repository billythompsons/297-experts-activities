...
# BookmarkBatch Lite Alternatives - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Weigh the bookmark managers honestly: import paths, export formats, and who actually owns your data. The product is a local-first Chrome extension: alternative records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active alternatives; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38581._
...
clean export: this build proves it in code (8 readiness points, suite-verified); data owned: this build proves it in code (6 readiness points, suite-verified); free tier: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #182 (Studio plan).
...
1. Click the **BookmarkBatch Lite Alternatives** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
BookmarkBatch Lite Alternatives today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
