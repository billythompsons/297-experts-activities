...
# Routine Map - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Map the routine you actually run: the trigger, the steps, the skip pattern, and the fix that makes it stick. The product is a local-first Chrome extension: routine records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active routines; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38903._
...
solid: this build proves it in code (8 readiness points, suite-verified); long streak: this build proves it in code (6 readiness points, suite-verified); skip known: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #260 (Studio plan).
...
1. Click the **Routine Map** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Routine Map today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
