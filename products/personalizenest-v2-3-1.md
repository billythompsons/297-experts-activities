...
# Personalizenest - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Rules-based content variations - match visitor facts (hour, weekday, device, referrer, login state, query, locale) to the right content variation, with a full "why this won" explanation view.

_Freemius store product #38492._
...
2. In the left sidebar, click **PersonalizeNest**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add rule** - work top to bottom.
...
Personalizenest today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
