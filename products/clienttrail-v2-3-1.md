...
# ClientTrail - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

The relationship trail: clients, timestamped notes (newest first), follow-up dates, and an attention list - overdue follow-ups sorted worst-first plus silent clients (no notes, no follow-up).

_Freemius store product #38349._
...
2. In the left sidebar, click **ClientTrail**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add client**. The records table's key columns: Client, Email, Notes, Follow-up, Actions.
...
ClientTrail today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
