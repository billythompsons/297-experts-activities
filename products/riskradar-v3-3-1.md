...
# RiskRadar — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Risk registers with likelihood x impact scoring, mitigation tracking, and review evidence. A risk closes only with a recorded mitigation and a review.

_Freemius store product #38515._

## The wedge (why ours wins)

Closure gating (mitigation + review required), evidence-carrying re-scoring reviews, forward-only event clock, score banding with worst-first board
...
2. In the left sidebar, click **Riskradar**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
RiskRadar — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
