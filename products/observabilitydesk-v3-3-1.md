...
# Observabilitydesk - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

WordPress operational event logs, health signals, and reviewable incident records without third-party telemetry: leveled channels, window health, ack-then-resolve incidents, retention that remaps references.

_Freemius store product #38484._

## What it does today

- Automated suite: 20 passed, 0 failed.
...
2. In the left sidebar, click **ObservabilityDesk**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Channel health (last hour), Log event, Recent events, Incidents**. The records table's key columns: Channel, Status, Events, Error %, ID.
...
Observabilitydesk today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
