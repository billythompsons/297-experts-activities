...
# CalendarLoom - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Availability weaving: store each person's busy blocks, compute common free slots of a chosen length inside the working day. Overlap-merge, strict time validation, no overnight windows.

_Freemius store product #38341._
...
2. In the left sidebar, click **CalendarLoom**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Busy blocks, Common free slots (30+ min, 08:00-18:00)** - work top to bottom.
...
CalendarLoom today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
