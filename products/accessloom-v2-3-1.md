...
# AccessLoom - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Audits your roles for takeover-capable capabilities: unfiltered_html, edit_plugins/themes, user management - who holds them, how many users are exposed, one risk score.

_Freemius store product #38325._
...
2. In the left sidebar, click **AccessLoom**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
AccessLoom today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
