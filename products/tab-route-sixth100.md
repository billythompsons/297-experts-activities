...
# Tab Route - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Route your reading: queue the tabs, order them by value, and finish the route instead of collecting it. The product is a local-first Chrome extension: reading route records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 12 active reading routes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38850._
...
route finished: this build proves it in code (8 readiness points, suite-verified); multi-link route: this build proves it in code (6 readiness points, suite-verified); clear goal: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #276 (Studio plan).
...
1. Click the **Tab Route** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Tab Route today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
