...
# WebCare - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Care-plan operations for maintenance teams: per-client plans with levels, recurring service tasks with enforced intervals, evidence-required work logging, and client-ready period reports.

_Freemius store product #38555._

## What it replaces

- [Agency Maintenance Activity Reports](https://wordpress.org/plugins/agency-maintenance-activity-reports/)
- [Site Updates Report](https://wordpress.org/plugins/site-updates-report/)
- [Website Maintenance Report](https://wordpress.org/plugins/website-maintenance-report/)
- [CareReport](https://wordpress.org/plugins/localreach-carereport/)

## The wedge (why ours wins)

Recurring tasks have real schedules: a weekly backup is due on day 7, and recording it early is rejected - the calendar is enforced; Work requires an evidence note and an author. "We did stuff" is not client-ready; an itemized, dated, attributed entry is; Reports aggregate per plan over an exact period, with MRR computed from plan levels - the business side is one glance away

## What it does today

- Automated suite: 26/26 checks, all green.
...
2. In the left sidebar, click **WebCare**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **Plans, Tasks due, Work entries, MRR** - read them left to right for the state of things.
4. The main sections are **Plans, New plan, Recurring task, Record work**. The records table's key columns: Client, Site, Level, Due now, Report.
...
WebCare today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
