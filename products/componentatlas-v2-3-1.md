...
# ComponentAtlas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

A registry of reusable components with strict placeholders: render-time validation names missing values AND catches value-key typos, PHP tags refused in templates, usage counted. Shortcode [componentatlas slug="hero-banner" ...].

_Freemius store product #38356._
...
2. In the left sidebar, click **ComponentAtlas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **' . esc_html( $cat ) . ', Register component**. The records table's key columns: Component, Slug, Placeholders, Uses.
...
ComponentAtlas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
