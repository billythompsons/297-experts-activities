...
# CartSmith - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Honest cart math for small digital sales: integer cents, merge-on-SKU, coupons (percent/fixed, expiry, min subtotal, never-below-zero), tax rounding documented. Shortcode [cartsmith_cart].

_Freemius store product #38343._
...
2. In the left sidebar, click **CartSmith**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
CartSmith today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
