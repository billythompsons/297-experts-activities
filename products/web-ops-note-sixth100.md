...
# Web Ops Note - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Ops notes for the sites you run: incidents, changes, and the rollback path, all in one ledger. The product is a local-first Chrome extension: ops note records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 15 active ops notes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38885._
...
sev1 with rollback ready: this build proves it in code (8 readiness points, suite-verified); closed cleanly: this build proves it in code (6 readiness points, suite-verified); on-call reachable: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #164 (Accelerator plan).
...
1. Click the **Web Ops Note** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Web Ops Note today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
