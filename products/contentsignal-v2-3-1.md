...
# ContentSignal - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Pre-publish editorial gate: structural, SEO, and readability signals with a readiness score on every draft, plus a paste-and-check standalone checker.

_Freemius store product #38366._
...
2. In the left sidebar, click **Contentsignal**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
ContentSignal today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
