...
# MediaLibraryplus - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Media governance and collections: curated collections with reviewer sign-off, content-hash duplicate detection, naming policy audits, and capacity limits.

_Freemius store product #38471._

## What it does today

- Automated suite: 21 passed, 0 failed.
...
2. In the left sidebar, click **MediaLibraryPlus**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New collection, Collections, Submit asset to collection, Duplicates (same content hash)**. The records table's key columns: Collection, Rule, Pending, Approved, Rejected.
...
MediaLibraryplus today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
