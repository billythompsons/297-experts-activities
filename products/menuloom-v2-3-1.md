...
# MenuLoom - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Navigation governance and testing: depth/label/duplicate-href/a11y audits on menu trees, plus deterministic label A/B tests with significance thresholds.

_Freemius store product #38477._
...
2. In the left sidebar, click **MenuLoom**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Menu audit, New label test, Tests**. The records table's key columns: Path, Rule, Detail, Test, Status.
...
MenuLoom today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
