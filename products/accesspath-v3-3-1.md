...
# AccessPath - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Audits your content's keyboard and navigation path: positive tabindex, unannounced new-tab links, same link text to different URLs, unlabeled form fields, unmuted autoplay media.

_Freemius store product #38326._
...
2. In the left sidebar, click **AccessPath**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
AccessPath today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
