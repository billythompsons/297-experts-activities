...
# Shortcut Slate - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Slate the shortcuts worth your fingers: the combo, the app, the time it saves, and the drill plan. The product is a local-first Chrome extension: shortcut records with 7 domain fields, a 3-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active shortcuts; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38824._
...
muscle memory: this build proves it in code (8 readiness points, suite-verified); high value: this build proves it in code (6 readiness points, suite-verified); drilled: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts

## What it does today

- Engine: 7 typed domain fields with validators, 3-gate quality workflow, weighted readiness scoring with 3 product-specific bonus rules, 3 milestones, 3 artifact generators, duplicate detection, search, free-limit enforcement, bounded import/export.
- Automated suite: 42 checks, all green.
- Canonical 297-map entry: feature #168 (Accelerator plan).
...
1. Click the **Shortcut Slate** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Shortcut Slate today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
