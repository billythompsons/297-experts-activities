...
# MediaForge Library — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Media inventory with accessibility sign-off and rights metadata enforcement.

_Freemius store product #38470._

## The wedge (why ours wins)

MediaForge combines accessibility and rights: alt quality is checked by rules (filename echo, stub, redundant prefix, length), sign-off requires someone other than the uploader and is voided by later edits, licenses are typed with required attribution, expired licenses make an asset unusable, and the audit shows exactly what needs attention. Competitors generate alt text; MediaForge governs the asset
...
2. In the left sidebar, click **MediaForge**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
MediaForge Library — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
