...
# Portable 200 Distribution - 297 in 501: Experts Activities
...
_Freemius store product #38497._
...
2. In the left sidebar, click **Portable 200 Distribution**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Operations, Feature scope, Create record, Create task**. The records table's key columns: Records, Review tasks, Scheduled runs, Last run, Retention.
...
Portable 200 Distribution today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
