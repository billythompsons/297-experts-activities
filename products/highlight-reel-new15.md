...
# Highlight Reel - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Reel in the highlights that matter: the passage, the note, the color code, and the export that makes research reusable. The product is a local-first Chrome extension: highlight records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active highlights; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [Highlight Reel](https://highlight-reel.app/)
- [Highlyt | Turn Highlights into AI-Readable Context](https://highlyt.app/)
- [Glasp: PDF & Web Highlighter for Researchers & Learners](https://glasp.co/)
- [Notate | AI Research Highlighter & Web Clipper for Notion & Obsidian](https://notate.so/)

## The wedge (why ours wins)

note adds judgment: this build proves it in code (8 readiness points, suite-verified); quote archived verbatim: this build proves it in code (6 readiness points, suite-verified); fuzzy anchor resilience: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage, activeTab, scripting permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #144 (Accelerator plan).
...
1. Click the **Highlight Reel** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Highlight Reel today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
