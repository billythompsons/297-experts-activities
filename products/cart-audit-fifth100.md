...
# Cart Audit - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Audit the cart before the charge: what each item costs, why it is there, and what leaves before checkout. The product is a local-first Chrome extension: cart item records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active cart items; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38597._
...
alternative priced: this build proves it in code (8 readiness points, suite-verified); cooled off: this build proves it in code (6 readiness points, suite-verified); decisive: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #16 (Starter plan).
...
1. Click the **Cart Audit** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Cart Audit today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
