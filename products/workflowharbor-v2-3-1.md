...
# WorkflowHarbor - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

General-purpose approvals: templates of ordered steps with named assignees, optional second-person approval gates, rejection with mandatory reasons that returns work one step, and a complete audit history per instance.

_Freemius store product #38558._

## What it replaces

- [AI Workflow Automation Lite](https://wordpress.org/plugins/ai-workflow-automation-lite/)
- [Krom Automation](https://wordpress.org/plugins/krom-automation/)
- [Content Flow Manager](https://wordpress.org/plugins/content-flow-manager/)
- [Bit Pi](https://wordpress.org/plugins/bit-pi/)

## The wedge (why ours wins)

Steps belong to named assignees: nobody can complete a step that is not theirs, and approval-gated steps wait for a DIFFERENT person; Rejection sends work back one step with a mandatory reason, not into a void; Every complete/approve/reject is an immutable audit entry - the history IS the compliance story
...
2. In the left sidebar, click **WorkflowHarbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **Templates, Running, Done, Cancelled** - read them left to right for the state of things.
4. The main sections are **Instances, New template, Start instance** - work top to bottom.
...
WorkflowHarbor today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
