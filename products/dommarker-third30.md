...
# DOMMarker - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Mark the DOM nodes that matter: the selector, why it breaks, and the test that guards it. The product is a local-first Chrome extension: marked node records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active marked nodes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38647._
...
- Canonical 297-map entry: feature #102 (Accelerator plan).
...
1. Click the **DOMMarker** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
DOMMarker today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
