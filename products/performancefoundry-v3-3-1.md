...
# Performancefoundry - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Performance baselines and budgets for TTFB, LCP, CLS, queries, and page weight - regressions must be acknowledged before a baseline can move, so slowdowns never get silently accepted.

_Freemius store product #38490._
...
2. In the left sidebar, click **PerformanceFoundry**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
Performancefoundry today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
