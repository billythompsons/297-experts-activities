...
# ComplianceCanvas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Compliance readiness board: obligations with real-date deadlines, evidence-required completion (a checkbox is not compliance), per-area scores + overdue flags.

_Freemius store product #38355._
...
2. In the left sidebar, click **ComplianceCanvas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Readiness, Obligations, Add obligation**. The records table's key columns: Area, Score, Open, Overdue, Requirement.
...
ComplianceCanvas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
