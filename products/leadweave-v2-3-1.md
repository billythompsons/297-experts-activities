...
# LeadWeave — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Lead pipelines with scoring, stale-lead detection, and win-rate evidence.

_Freemius store product #38460._

## The wedge (why ours wins)

LeadWeave keeps the pipeline as inspectable data: one open lead per email (duplicates refused), every stage move and point change lands in the lead's history, scoring is an explicit formula (source + value + stage + manual points with reasons), and stale leads surface by inactivity rather than manual review. Competitors store contacts; LeadWeave proves pipeline discipline
...
2. In the left sidebar, click **LeadWeave**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
LeadWeave — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
