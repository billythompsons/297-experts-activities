...
# DesignHandoff - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Hand a design to engineering without the telephone game: specs, assets, states, and acceptance. The product is a local-first Chrome extension: handoff records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active handoffs; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38645._
...
error and empty states covered: this build proves it in code (8 readiness points, suite-verified); responsive spec: this build proves it in code (6 readiness points, suite-verified); accepted by engineering: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #107 (Accelerator plan).
...
1. Click the **DesignHandoff** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
DesignHandoff today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
