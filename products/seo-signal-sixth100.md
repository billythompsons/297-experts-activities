...
# SEO Signal - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Signal the page's search health: the target query, the intent match, the title test, and the content gap. The product is a local-first Chrome extension: page records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active pages; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38821._
...
page one: this build proves it in code (8 readiness points, suite-verified); query in title: this build proves it in code (6 readiness points, suite-verified); strong: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #156 (Accelerator plan).
...
1. Click the **SEO Signal** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
SEO Signal today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
