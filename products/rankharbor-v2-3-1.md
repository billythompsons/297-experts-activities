...
# RankHarbor — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Keyword rank tracking with movement alerts. Records observed positions, flags big movers, top-10 entries and exits, and gives a digest of where every keyword stands.

_Freemius store product #38508._

## The wedge (why ours wins)

Append-only forward-only ranking history, threshold-based movement alerts, first-class unranked state, local-only storage. No API key, no external account
...
2. In the left sidebar, click **Rankharbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
RankHarbor — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
