...
# WebinarWorks - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Webinar operations: draft -> ready gating on fully confirmed speakers, reviewed registration with automatic waitlisting at capacity, attendance check-in, and evidence-backed follow-ups.

_Freemius store product #38557._

## What it replaces

- [WebinarIgnition](https://wordpress.org/plugins/webinar-ignition/)
- [WP WebinarSystem](https://en-au.wordpress.org/plugins/wp-webinarsystem/)
- [Zoomeet](https://wordpress.org/plugins/zoomeet/)
- [MeetingHub](https://wordpress.org/plugins/meetinghub/)

## The wedge (why ours wins)

A webinar cannot open registration until every speaker is confirmed - the plan is enforced, not aspirational; Capacity is real: approvals past the limit waitlist automatically, and waitlisted people cannot be marked attended; Follow-ups require attendance and a note - the post-event work is evidence, not a memory

## What it does today

- Automated suite: 29/29 checks, all green.
...
2. In the left sidebar, click **WebinarWorks**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New webinar, Add speaker**. The records table's key columns: ID, Name, Email, Status, Attended.
...
WebinarWorks today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
