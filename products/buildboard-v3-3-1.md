...
# BuildBoard - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Kanban for build work: quoted -> approved -> in-progress -> review -> done, no stage skipping, WIP limit of 3 in progress, weighted pipeline forecast.

_Freemius store product #38338._
...
2. In the left sidebar, click **BuildBoard**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New job** - work top to bottom.
...
BuildBoard today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
