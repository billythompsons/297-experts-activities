...
# Landmark Lens - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

See the page like a screen reader: the landmarks, their labels, and the regions nobody can jump to. The product is a local-first Chrome extension: landmark audit records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active landmark audits; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38697._
...
- Canonical 297-map entry: feature #132 (Accelerator plan).
...
1. Click the **Landmark Lens** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Landmark Lens today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
