...
# UserJourney - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

UX evidence pipeline: severity-scored observations triaged into issues with impact/effort scoring and a computed priority queue, review-first improvement plans, ship gating, and verification that resolves the underlying observations - keeping "shipped" and "fixed" honest.

_Freemius store product #38550._

## What it replaces

- [Opti Behavior](https://wordpress.org/plugins/opti-behavior/)
- [TrackSure](https://wordpress.org/plugins/tracksure/)
- [Kantan Analytics](https://wordpress.org/plugins/kantan-analytics/)
- [Path Pilot](https://wordpress.org/plugins/path-pilot/)

## The wedge (why ours wins)

Observations become ISSUES with impact and effort scores - a computed priority queue (impact x2 - effort), not an opinion fight; Improvement plans are review-first: the proposer can never approve their own plan, and only approved plans ship; The loop closes: shipping an issue does NOT resolve its observations - verification does. "We shipped" and "it's fixed" stay separate facts
...
2. In the left sidebar, click **UserJourney**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Log observation, Triage into issue, Propose improvement** - work top to bottom.
...
UserJourney today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
