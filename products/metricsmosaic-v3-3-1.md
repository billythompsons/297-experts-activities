...
# MetricSmosaic - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Local metric definitions, evidence-noted readings, reviewer sign-off, and trend/status reporting - KPI operations without external analytics services.

_Freemius store product #38480._
...
2. In the left sidebar, click **MetricsMosaic**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Scorecard, Define metric, Record reading, Review queue**. The records table's key columns: Metric, Target, Latest reviewed, Status, WoW.
...
MetricSmosaic today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
