...
# FrontendSignals — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Front-end health and interaction checks: Core Web Vitals grading, trends, and worst-page triage.

_Freemius store product #38433._
...
- Automated suite: 24 passed, 0 failed.
...
2. In the left sidebar, click **Frontendsignals**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
FrontendSignals — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
