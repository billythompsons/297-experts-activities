...
# RedirectRegistry — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Review-first redirect inventory with 404 triage. Redirects move proposed to approved to retired; only approved entries route traffic, and loops are refused at approval time.

_Freemius store product #38510._

## The wedge (why ours wins)

Review-first state machine (proposed/live/retired), approve-time loop detection with rollback, worst-first 404 triage tied to registration state, forward-only 404 log
...
2. In the left sidebar, click **Redirectregistry**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
RedirectRegistry — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
