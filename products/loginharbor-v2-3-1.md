...
# LoginHarbor — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Login throttling with backoff and access review with sign-off evidence.

_Freemius store product #38466._

## The wedge (why ours wins)

LoginHarbor pairs the throttle with the review: lockouts escalate exponentially per repeat offender while a sliding window forgives old failures, and the access-review side enforces sign-off separation (nobody reviews their own access), surfaces dormant and privileged accounts, and tracks review staleness. Competitors guard the door; LoginHarbor also audits who holds keys
...
2. In the left sidebar, click **LoginHarbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
LoginHarbor — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
