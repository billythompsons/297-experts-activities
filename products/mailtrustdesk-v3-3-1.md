...
# MailTrust Desk — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Sender identity review, message-event records, and deliverability posture.

_Freemius store product #38467._

## The wedge (why ours wins)

MailTrust Desk treats deliverability as evidence: sender verification requires SPF+DKIM+DMARC together, message events enforce ordering (nothing before sent, sent once), hard bounces and complaints auto-suppress and block future sends, and the posture grade is computed from your own event record with explicit thresholds. Competitors route or log email; MailTrust grades and guards it
...
2. In the left sidebar, click **MailTrust Desk**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
MailTrust Desk — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
