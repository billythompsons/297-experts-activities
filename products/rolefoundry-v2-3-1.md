...
# RoleFoundry — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Role and capability governance with a reason-carrying grant/revoke ledger. Effective permissions are always derived from the ledger, never edited directly - every change has a who and a why.

_Freemius store product #38516._

## The wedge (why ours wins)

Append-only reason-carrying ledger as the source of truth, derived (never stored) effective capabilities, contradiction-proof grant/revoke, per-role audit view, cross-role who-has report
...
2. In the left sidebar, click **Rolefoundry**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
RoleFoundry — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
