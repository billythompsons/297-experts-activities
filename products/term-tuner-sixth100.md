...
# Term Tuner - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Turn dense contract terms into plain language you can actually act on, with risk attached. The product is a local-first Chrome extension: term records with 8 domain fields, a 5-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active terms; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38906._
...
- Canonical 297-map entry: feature #282 (Studio plan).
...
1. Click the **Term Tuner** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Term Tuner today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
