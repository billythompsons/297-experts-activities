...
# SupplySignal - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Supply-chain signal + exception pipeline: typed severity-scored signals per lane, auto-escalation at severity 4+, continuity plans with review-first approval (author != reviewer), resolution gating, 3-day aging view.

_Freemius store product #38535._

## What it replaces

- [Shelf Planner](https://wordpress.org/plugins/shelf-planner/)
- [StockOracle AI](https://wordpress.org/plugins/stockoracle-ai/)
- [Low Stock Alerts for WooCommerce](https://wordpress.org/plugins/rixonapps-low-stock-alerts-for-woocommerce/)
- [Nventory](https://wordpress.org/plugins/nventory/)

## The wedge (why ours wins)

Signals are typed and severity-scored; 4+ auto-escalates to a tracked exception instead of an email nobody owns; Continuity planning is review-first by construction: the plan author CANNOT approve their own plan - enforced in the engine, unit-tested; Aging view surfaces exceptions sitting open 3+ days
...
2. In the left sidebar, click **SupplySignal**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Record signal** - work top to bottom.
...
SupplySignal today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
