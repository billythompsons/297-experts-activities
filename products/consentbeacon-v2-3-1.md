...
# ConsentBeacon - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Granular cookie consent: necessary forced on, optional categories default OFF (never pre-checked), versioned policy - bumping the version re-prompts everyone and stale consent stops authorizing. [cbeacon_gate category="analytics"]...[/cbeacon_gate].

_Freemius store product #38357._
...
2. In the left sidebar, click **ConsentBeacon**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add category, Policy change**. The records table's key columns: Category, Slug, Required.
...
ConsentBeacon today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
