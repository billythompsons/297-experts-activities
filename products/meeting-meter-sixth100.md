...
# Meeting Meter - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Meter the meeting load: hours, cost in salary time, and the weekly cap that protects deep work. The product is a local-first Chrome extension: week records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active weeks; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38718._
...
under cap: this build proves it in code (8 readiness points, suite-verified); deep work protected: this build proves it in code (6 readiness points, suite-verified); cut planned: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #44 (Pro plan).
...
1. Click the **Meeting Meter** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Meeting Meter today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
