...
# Draft Compass - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Steer a draft from mess to ship: which pass it is in, what this pass fixes, and what done looks like. The product is a local-first Chrome extension: draft records with 10 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 12 active drafts; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38648._
...
reader test defined: this build proves it in code (8 readiness points, suite-verified); length on target: this build proves it in code (6 readiness points, suite-verified); final pass discipline: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 50 checks, all green.
- Canonical 297-map entry: feature #94 (Pro plan).
...
1. Click the **Draft Compass** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Draft Compass today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
