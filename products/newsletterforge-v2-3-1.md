...
# NewsletterForge - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Newsletter planning and audience exports: double opt-in with tokens, global suppression (bounce/complaint/manual), future-dated campaigns, tag-segmented CSV exports of confirmed subscribers only.

_Freemius store product #38482._
...
2. In the left sidebar, click **NewsletterForge**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add subscriber, Plan campaign, Campaigns, Audience preview (' . count($aud) . ')**. The records table's key columns: ID, Subject, Send on, Status.
...
NewsletterForge today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
