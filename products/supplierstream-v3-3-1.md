...
# SupplierStream - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Supplier registry + qualification pipeline: prospect -> under_review -> qualified/rejected, weighted scorecards (quality 50 / delivery 30 / price 20) against a 70-point bar, per-supplier certification expiry tracking, one-way procurement handoffs with PO dedup.

_Freemius store product #38534._

## What it replaces

- [Supplier and Purchase Order Management for WooCommerce](https://wordpress.org/plugins/supplier-and-purchase-order-management-for-woocommerce/)
- [Product Vendor Manager](https://wordpress.org/plugins/product-vendor-manager-for-woocommerce/)
- [Suppliers Manager for WooCommerce](https://wordpress.org/plugins/suppliers-manager-for-woocommerce/)
- [OpsAssist Data Bridge](https://wordpress.org/plugins/opsassist-data-bridge-for-woocommerce/)

## The wedge (why ours wins)

Qualification is earned: quality/delivery/price scorecards weighted 50/30/20 against a hard 70-point bar - a weak supplier CANNOT be qualified by accident; Certification expiry is tracked per supplier with expired/sorting views; Handoff to procurement is one-way with duplicate-PO rejection - audit-safe

## What it does today

- Automated suite: 28 passed, 0 failed.
...
2. In the left sidebar, click **SupplierStream**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Certifications expiring, New supplier, Procurement handoffs**. The records table's key columns: Supplier, Cert, Expiry, PO, When.
...
SupplierStream today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
