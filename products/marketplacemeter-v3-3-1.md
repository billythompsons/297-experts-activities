...
# MarketplaceMeter — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Vendor onboarding, offer moderation, and marketplace metrics with decision evidence.

_Freemius store product #38469._

## The wedge (why ours wins)

MarketplaceMeter is the governance layer: unapproved vendors cannot submit, zero-stock offers cannot go live, rejections and suspensions require reasons, suspension auto-pauses live offers, and every decision is recorded with reviewer and timestamp. The big marketplace plugins optimize for selling; MarketplaceMeter proves the gate was run
...
2. In the left sidebar, click **MarketplaceMeter**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
MarketplaceMeter — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
