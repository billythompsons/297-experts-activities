...
# LinguaFlow — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Translation inventory with coverage review and translator/approver separation.

_Freemius store product #38462._

## The wedge (why ours wins)

LinguaFlow keeps review inside WordPress as enforceable data: placeholder mismatches are refused at submit, approval requires a different person than the translator, source edits stale prior approvals, and exports contain only approved, current translations. Competitors automate or outsource translation; LinguaFlow proves the review happened
...
2. In the left sidebar, click **LinguaFlow**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
LinguaFlow — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
