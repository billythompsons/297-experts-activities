...
# Dark Shift - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Shift sites into dark on your schedule: the inversion recipe, the contrast floor, and the per-site exceptions that stick. The product is a local-first Chrome extension: shift records with 10 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active shifts; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [gmdahri/DarkShift---Dark-Mode-Extension](https://github.com/gmdahri/DarkShift---Dark-Mode-Extension)
- [Modern Dark Mode — Free Dark Mode Chrome Extension](https://bushe.co/modern-dark-mode/)
- [Night Eye Features – Customizable Dark Mode Extension](https://nighteye.app/features/)
- [DarkWave — Smart Dark Mode Everywhere](https://tjmanoj.github.io/darkwave/)

## The wedge (why ours wins)

AA floor or better: this build proves it in code (8 readiness points, suite-verified); exceptions mapped: this build proves it in code (6 readiness points, suite-verified); scheduled, not manual: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage, activeTab, scripting permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 47 checks, all green.
- Canonical 297-map entry: feature #288 (Studio plan).
...
1. Click the **Dark Shift** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Dark Shift today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
