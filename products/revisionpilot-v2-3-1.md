...
# RevisionPilot — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Revision review and rollback controls with append-only history. Rollbacks create a new revision that restores old content - nothing is ever deleted - and publishing follows the latest approved revision.

_Freemius store product #38514._

## The wedge (why ours wins)

Append-only history with reason-carrying rollback revisions, explicit approval gating for what publishes, no-op commit refusal, and diff counts computed per revision pair
...
2. In the left sidebar, click **Revisionpilot**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
RevisionPilot — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
