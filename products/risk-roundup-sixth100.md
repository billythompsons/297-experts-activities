...
# Risk Roundup - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Round up the risks before they round you up: the likelihood, the blast, the mitigation, and the owner. The product is a local-first Chrome extension: risk records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active risks; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38806._
...
closed: this build proves it in code (8 readiness points, suite-verified); owned: this build proves it in code (6 readiness points, suite-verified); real mitigation: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
1. Click the **Risk Roundup** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Risk Roundup today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
