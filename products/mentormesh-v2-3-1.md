...
# Mentormesh - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Mentor matching and session tracking: skill-overlap ranking with capacity awareness, match lifecycle, validated session logs, mentee ratings.

_Freemius store product #38476._
...
2. In the left sidebar, click **MentorMesh**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add mentor, Mentors, Propose match, Matches**. The records table's key columns: Mentor, Skills, Capacity, Active, Minutes.
...
Mentormesh today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
