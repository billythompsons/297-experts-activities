...
# A11Ycoach - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Local-first accessibility audit coach for any web page: scan the rendered page for WCAG issues, explain each finding in plain language with a concrete fix, and keep a per-site history so the user can prove issues got fixed and catch regressions. Grounded in the proven sibling build (github.com/billythompsons/a11ycoach: "Local-first accessibility audits, guided evidence, regression tracking and Freemius-ready entitlements"). The template config's "Pocket" hint was wrong-domain and is discarded.

_Freemius store product #38563._
...
Free tier must match WAVE/axe-free detection basics AND ship the two things neither has free: plain-language fix coaching and local regression history. Premium (Freemius product 37836) adds full ruleset depth, export formats, and longer history

## What it does today

- Canonical 297-map entry: feature #135 (Accelerator plan).
...
1. Click the **A11Ycoach** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
A11Ycoach today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
