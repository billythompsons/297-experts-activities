...
# VolunteerGrid - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Volunteer operations: skill- and safeguarding-gated shifts with enforced capacity and overlap protection, check-ins, and service hours that only count once a second person verifies them.

_Freemius store product #38554._
...
- [EventAdmin](https://wordpress.org/plugins/eventadmin-volunteer-management/)
- [Signteer](https://wordpress.org/plugins/signteer/)

## The wedge (why ours wins)

Sensitive shifts are structurally gated: expired safeguarding clearance blocks signup, even if the volunteer was cleared once; Skills gate shifts, capacities are enforced, and same-day overlapping shifts cannot double-book a volunteer; Service hours are evidence: they count toward "verified" totals only when a DIFFERENT person confirms them - self-verification is rejected

## What it does today

- Automated suite: 37/37 checks, all green.
...
2. In the left sidebar, click **VolunteerGrid**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **Shifts, Volunteers, Safeguarded, Unverified hours** - read them left to right for the state of things.
4. The main sections are **Shifts, Volunteers, Add volunteer, Add shift**. The records table's key columns: Shift, When, Capacity, Flags, Roster.
...
VolunteerGrid today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
