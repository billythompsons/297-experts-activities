...
# APICompass - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Health-checks your API endpoints: expected status per URL, ok / slow / wrong-status / down classification, SSRF-guarded targets, one healthy/not verdict.

_Freemius store product #38328._
...
2. In the left sidebar, click **APICompass**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add check**. The records table's key columns: Check, URL, State, Detail.
...
APICompass today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
