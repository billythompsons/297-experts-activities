...
# Metaforge - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Metadata templates and bulk editing: placeholder templates with whitelists, render + lint (60/160 limits), literal find/replace with dry-run previews that skip overflow.

_Freemius store product #38478._

## What it does today

- Automated suite: 19 passed, 0 failed.
...
2. In the left sidebar, click **MetaForge**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New template, Templates, Dry-run preview, Bulk find/replace**. The records table's key columns: ID, Field, Pattern, Preview, Lint.
...
Metaforge today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
