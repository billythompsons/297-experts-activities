...
# CSS Inspector - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Inspect the style drift: the property that wandered, the value it should have, and the override that wins. The product is a local-first Chrome extension: style fix records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active style fixes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38634._
...
- Canonical 297-map entry: feature #118 (Accelerator plan).
...
1. Click the **CSS Inspector** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
CSS Inspector today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
