...
# ReleaseSentinel — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Release readiness gates with required evidence and rollback records. A release ships only when every required check has evidence; rolled-back releases become immutable.

_Freemius store product #38511._

## The wedge (why ours wins)

Evidence-gated shipping (required checks must carry written evidence), forward-only per-release event clock, immutable shipped/rolled-back records, readiness board sorted by target date
...
2. In the left sidebar, click **Releasesentinel**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
ReleaseSentinel — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
