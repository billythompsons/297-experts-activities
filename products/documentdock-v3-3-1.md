...
# DocumentDock - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Document lifecycle management with ownership, review workflow, expiry tracking, and a bounded evidence trail.

_Freemius store product #38382._
...
- Automated suite: 42 passed, 0 failed.
...
2. In the left sidebar, click **Documentdock**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
DocumentDock today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
