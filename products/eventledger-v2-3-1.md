...
# Eventledger - 297 in 501: Experts Activities
...
_Freemius store product #38397._
...
2. In the left sidebar, click **Eventledger**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
Eventledger today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
