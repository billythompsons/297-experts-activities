...
# Standup Stack - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Stack the standup into sixty seconds: yesterday, today, the blocker, and the ask that unblocks it. The product is a local-first Chrome extension: standup records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active standups; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38835._
...
- Canonical 297-map entry: feature #54 (Pro plan).
...
1. Click the **Standup Stack** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Standup Stack today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
