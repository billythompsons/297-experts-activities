...
# CommentLedger - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Comment triage with an auditable trail: ordered rules (keyword, max-links, min-length) that hold or mark spam - never auto-delete - plus an append-only decision log with reasons and stats.

_Freemius store product #38352._
...
2. In the left sidebar, click **CommentLedger**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add rule, Decision ledger**. The records table's key columns: When, Ref, Decision, Reason.
...
CommentLedger today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
