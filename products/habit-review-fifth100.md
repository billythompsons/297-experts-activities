...
# Habit Review - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Review habits like a coach: streak, trigger, friction, and whether it still deserves the slot. The product is a local-first Chrome extension: habit records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 12 active habits; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38678._
...
two-week streak: this build proves it in code (8 readiness points, suite-verified); friction fix in place: this build proves it in code (6 readiness points, suite-verified); honest drop: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #18 (Starter plan).
...
1. Click the **Habit Review** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Habit Review today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
