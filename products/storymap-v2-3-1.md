...
# StoryMap - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Content relationship map: typed nodes (article/chapter/landing) with planning status, directed links with cycle rejection, reading-path walks, hub ranking, orphan detection.

_Freemius store product #38532._

## What it replaces

- [Native Content Relationships](https://wordpress.org/plugins/native-content-relationships/)
- [PublishPress](https://wordpress.org/plugins/publishpress/)
- [SiteAssist AI Editorial Planner](https://wordpress.org/plugins/siteassist-ai-editorial-planner/)
- [Tidy Content Planner](https://wordpress.org/plugins/tidy-content-planner/)

## The wedge (why ours wins)

The map is a real directed graph: cycle-safe links, walkable reading paths, hub ranking by inbound count, orphan detection - derived, not hand-maintained; Planning states (idea/draft/published) live on the same nodes as the structure; Landing-page-aware: entry points never flagged as orphans

## What it does today

- Automated suite: 33 passed, 0 failed.
...
2. In the left sidebar, click **StoryMap**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New node, Link nodes** - work top to bottom.
...
StoryMap today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
