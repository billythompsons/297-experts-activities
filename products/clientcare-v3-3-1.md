...
# ClientCare - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Support tickets with real SLA clocks: urgent 4h / normal 24h / low 72h first-response budgets, legal state machine (reopen resets the clock), breach dashboard.

_Freemius store product #38347._
...
2. In the left sidebar, click **ClientCare**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Open ticket**. The records table's key columns: Subject, Requester, Priority, State, SLA.
...
ClientCare today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
