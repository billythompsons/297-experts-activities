...
# Support Session Brief - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Brief the support call before it starts: the issue, what was tried, the logs, and the ask in one line. The product is a local-first Chrome extension: session records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active sessions; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38846._
...
resolved: this build proves it in code (8 readiness points, suite-verified); ID ready: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts

## What it does today

- Engine: 7 typed domain fields with validators, 4-gate quality workflow, weighted readiness scoring with 2 product-specific bonus rules, 3 milestones, 3 artifact generators, duplicate detection, search, free-limit enforcement, bounded import/export.
- Automated suite: 38 checks, all green.
- Canonical 297-map entry: feature #273 (Studio plan).
...
1. Click the **Support Session Brief** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Support Session Brief today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
