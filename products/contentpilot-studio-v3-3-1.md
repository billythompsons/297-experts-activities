...
# ContentPilot Studio - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Editorial pipeline board: briefs move ideation to published through a guarded workflow with approvals, workload, overdue, and schedule-conflict detection.

_Freemius store product #38363._
...
2. In the left sidebar, click **Contentpilot Studio**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
ContentPilot Studio today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
