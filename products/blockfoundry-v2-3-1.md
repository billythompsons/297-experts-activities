...
# BlockFoundry - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Forge and register your own block patterns: validated block markup (unclosed blocks, script tags, and blockless content rejected), categories, block counts, registered as real WP block patterns.

_Freemius store product #38336._
...
2. In the left sidebar, click **BlockFoundry**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Forge a pattern**. The records table's key columns: Title, Slug, Categories, Blocks.
...
BlockFoundry today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
