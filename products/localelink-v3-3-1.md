...
# LocaleLink — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Locale ownership and regional content review with shippable-state evidence.

_Freemius store product #38464._

## The wedge (why ours wins)

LocaleLink models accountability: each locale has a named owner with a transfer log, pages move through pending/in-review/approved only by the owning reviewer, unowned locales block progress visibly, and the shippable list is computed from approval evidence. Competitors translate content; LocaleLink governs regional sign-off
...
2. In the left sidebar, click **LocaleLink**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
LocaleLink — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
