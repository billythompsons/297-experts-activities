...
# YieldYard - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Revenue optimization governance: opportunities scored and ranked by value x confidence / effort, second-person approval, and experiments that cannot be decided until both arms meet the declared minimum sample.

_Freemius store product #38561._

## What it replaces

- [ABTestKit](https://wordpress.org/plugins/abtestkit/)
- [Sigmize](https://wordpress.org/plugins/sigmize/)
- [PageTest AI](https://wordpress.org/plugins/pagetest-ai/)
- [VariantFlow](https://wordpress.org/plugins/variantflow/)

## The wedge (why ours wins)

Ideas are scored (value x confidence / effort) so the backlog ranks itself, and approval requires a second person - never the author; Decisions are sample-gated: ship or kill is structurally impossible until BOTH arms clear the declared minimum; Data freezes at decision time - no moving the goalposts after the fact

## What it does today

- Automated suite: 32 passed, 0 failed.
...
2. In the left sidebar, click **YieldYard**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **Experiments** - read them left to right for the state of things.
4. The main sections are **Backlog (approved, best first), Opportunities, Experiments, Note opportunity**. The records table's key columns: Opportunity, Score, Title, Value/mo, Confidence.
...
YieldYard today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
