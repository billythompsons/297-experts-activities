...
# ContactHarbor - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Contact intake with layered anti-spam: honeypot, 2-second min fill time, per-sender rolling-hour rate limit (5), link cap - then a real inbox (unread newest-first, read/unread).

_Freemius store product #38360._
...
2. In the left sidebar, click **ContactHarbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
ContactHarbor today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
