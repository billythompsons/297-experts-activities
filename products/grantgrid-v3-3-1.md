...
# GrantGrid — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Grant pipeline for nonprofits: applications, evidence checklists, eligibility gates, and deadline urgency.

_Freemius store product #38437._
...
2. In the left sidebar, click **GrantGrid**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
GrantGrid — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
