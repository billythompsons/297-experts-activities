...
# SubscriptionHarbor - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Subscription lifecycle engine: plans with weekly/monthly/yearly intervals, subscribers with anchor dates and trials, guarded state transitions, dunning with 3-strike auto-cancel, normalized MRR, next-charge computation.

_Freemius store product #38533._
...
- [Array Subscriptions](https://wordpress.org/plugins/arraysubs/)
- [Recurio](https://wordpress.org/plugins/recurio/)

## The wedge (why ours wins)

Explicit lifecycle state machine with guarded transitions (trialing cannot go past due; canceled cannot reactivate) - behavior is provable, not implied; Dunning is real: strike counter, 3-strike sweep cancels automatically; MRR normalizes weekly/monthly/yearly to one comparable monthly number; Next-charge math is interval- and trial-aware, and unit-tested across year boundaries
...
2. In the left sidebar, click **SubscriptionHarbor**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New plan, New subscription, Dunning sweep** - work top to bottom.
...
SubscriptionHarbor today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
