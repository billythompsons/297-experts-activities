...
# Tone Check - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Check the tone before you send: the audience, the risk words, and the rewrite that lands it. The product is a local-first Chrome extension: tone check records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active tone checks; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38866._
...
landed the rewrite: this build proves it in code (8 readiness points, suite-verified); risk words caught: this build proves it in code (6 readiness points, suite-verified); clean send: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #68 (Pro plan).
...
1. Click the **Tone Check** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Tone Check today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
