...
# QR Forge - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Forge the QR code before you print it: the payload, the error margin, the size, and the scan test that proves it. The product is a local-first Chrome extension: code records with 10 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active codes; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [ben-gy/qrforge](https://github.com/ben-gy/qrforge)
- [QR Code Generator Online | Create Custom QR Codes Free | GetDevUtils](https://getdevutils.com/qr-forge)
- [QR Code Generator - Chrome Web Store](https://chromewebstore.google.com/detail/qr-code-generator/afpbjjgbdimpioenaedcjgkaigggcdpp)
- [QR Code Generator Online — Custom Colors and Size](https://www.uwarp.design/qr-code-generator)

## The wedge (why ours wins)

high error margin for print: this build proves it in code (8 readiness points, suite-verified); distance-sized modules: this build proves it in code (6 readiness points, suite-verified); real-world scan pass: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #251 (Studio plan).
...
1. Click the **QR Forge** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
QR Forge today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
