...
# AIWardens - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Enforces your AI-content policy: flags known AI tell phrases in posts (phrase-based, honestly labeled - not AI-authorship detection) and requires an AI-use disclosure when they appear.

_Freemius store product #38327._
...
2. In the left sidebar, click **AIWardens**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Policy**. The records table's key columns: Post, Verdict, Findings.
...
AIWardens today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
