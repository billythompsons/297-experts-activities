...
# LinkPilot — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Internal-link discovery and governance - orphans, overuse, and suggestions.

_Freemius store product #38463._

## The wedge (why ours wins)

LinkPilot treats the internal link structure as governed data: self-links, duplicates, and unknown endpoints are refused at write time; governance limits (outbound caps, anchor overuse) are computed violations, not best-effort advice; and suggestions match page keywords against pasted content while skipping already-linked targets. Competitors auto-insert or just report; LinkPilot validates and governs
...
2. In the left sidebar, click **LinkPilot**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
LinkPilot — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
