...
# Tab Compass - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

A compass for the current session: where you are, why this tab is open, and where you meant to go. The product is a local-first Chrome extension: session note records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active session notes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38848._
...
- Canonical 297-map entry: feature #275 (Studio plan).
...
1. Click the **Tab Compass** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Tab Compass today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
