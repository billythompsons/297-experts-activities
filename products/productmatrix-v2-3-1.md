...
# ProductMatrix - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Product options and bundles - validated option groups with price deltas, and bundles that must cost less than their parts.

_Freemius store product #38501._
...
2. In the left sidebar, click **ProductMatrix**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Option groups, Products, Bundles** - work top to bottom.
...
ProductMatrix today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
