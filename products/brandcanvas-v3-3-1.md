...
# BrandCanvas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Your brand kit, enforced: palette (unique names + hexes), typography with a modular type ramp, and a WCAG contrast audit that flags any palette pair below AA 4.5.

_Freemius store product #38337._
...
2. In the left sidebar, click **BrandCanvas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Palette, Typography**. The records table's key columns: Swatch, Name, Hex, Role.
...
BrandCanvas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
