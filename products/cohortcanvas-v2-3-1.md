...
# CohortCanvas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Cohort retention matrix from data you already have: signup-month cohorts, M0..Mn retention percents, beyond-horizon cells are null (never fake zeros), worst-M1 cohort flagged.

_Freemius store product #38350._
...
2. In the left sidebar, click **CohortCanvas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
CohortCanvas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
