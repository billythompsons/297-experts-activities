...
# CalendarCraft - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

A small honest event calendar: strict date validation, multi-day spans, Monday-first month grid with leap-correct day counts, shortcode [calendarcraft].

_Freemius store product #38340._
...
2. In the left sidebar, click **CalendarCraft**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add event**. The records table's key columns: ' . $d . ', When, Event, Where.
...
CalendarCraft today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
