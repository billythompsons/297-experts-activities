...
# MemberMatrix - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Membership access maps, renewal review, and member-service records: a role-area access matrix, a renewal queue sorted by due date, and categorized service records with SLA breach flags.

_Freemius store product #38474._
...
2. In the left sidebar, click **MemberMatrix**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Access matrix, Renewal review (14 days), Service records**. The records table's key columns: Role, ' . esc_html($ar) . '.
...
MemberMatrix today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
