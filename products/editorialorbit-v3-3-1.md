...
# EditorialOrbit - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Assignment desk for editorial teams: assignments with writers and deadlines, escalation tiers, and a publication-readiness checklist that gates clearance.

_Freemius store product #38386._
...
- Automated suite: 37 passed, 0 failed.
...
2. In the left sidebar, click **Editorialorbit**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
EditorialOrbit today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
