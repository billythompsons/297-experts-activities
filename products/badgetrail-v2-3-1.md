...
# BadgeTrail - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Member achievement badges: define badges over posts/comments/logins/days-member thresholds, auto-award on evaluation (never double-awarded), per-user trail newest-first.

_Freemius store product #38335._
...
2. In the left sidebar, click **BadgeTrail**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Badges, Recent awards, Add badge**. The records table's key columns: Name, Earn at, Blurb.
...
BadgeTrail today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
