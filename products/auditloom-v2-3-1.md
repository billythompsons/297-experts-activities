...
# AuditLoom - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

A lean audit trail: records logins (incl. failed), post create/update/delete, and role changes; queryable by action/actor/date; retention pruning; security digest with failed-login alarm.

_Freemius store product #38332._
...
2. In the left sidebar, click **AuditLoom**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
AuditLoom today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
