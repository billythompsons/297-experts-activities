...
# ThemeCanvas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Design-token governance: typed tokens (color/size/font) with validation, second-person approval, themes that bind tokens to slots, declared text/bg pairs, WCAG AA contrast enforcement at publish, frozen published themes.

_Freemius store product #38541._

## What it replaces

- [Theme.json Design Manager](https://wordpress.org/plugins/theme-json-design-manager/)
- [Stylo](https://wordpress.org/plugins/yaotw-stylo/)
- [Theme Designer](https://wordpress.org/plugins/theme-designer/)
- [Slashed](https://wordpress.org/plugins/slashed/)

## The wedge (why ours wins)

Tokens are typed and validated at definition: colors are real #rrggbb, sizes carry units, fonts carry stacks; Governance is structural: the proposer can NEVER approve their own token; Publish is earned: every bound token approved, every declared text/background pair passes WCAG AA (4.5:1) computed with the real luminance formula - and published themes freeze
...
2. In the left sidebar, click **ThemeCanvas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Define token, New theme** - work top to bottom.
...
ThemeCanvas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
