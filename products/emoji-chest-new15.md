...
# Emoji Chest - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Chest the emoji you actually use: the search word that finds it, the skin tone you mean, and the recents that stay yours. The product is a local-first Chrome extension: entry records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active entries; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [Emoji Anywhere: type :shortcodes: for emojis in any text field](https://emojianywhere.com/)
- [Emoji Picker & Copy | Unicode 16, shortcodes | Tools-Chain](https://tools-chain.com/text/emoji-copy-paste)
- [ChipenYip/emoji-symbols-copy-paste](https://github.com/ChipenYip/emoji-symbols-copy-paste)

## The wedge (why ours wins)

three or more personal search words: this build proves it in code (8 readiness points, suite-verified); tone locked: this build proves it in code (6 readiness points, suite-verified); combo mapped: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 44 checks, all green.
- Canonical 297-map entry: feature #133 (Accelerator plan).
...
1. Click the **Emoji Chest** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Emoji Chest today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
