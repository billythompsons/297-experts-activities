...
# Claim Map - 297 in 501: Experts Activities
...
_Freemius store product #38606._
...
- Canonical 297-map entry: feature #11 (Free plan).
...
1. Click the **Claim Map** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Claim Map today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
