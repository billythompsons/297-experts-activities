...
# Screen Ruler - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Ruler the screen like a print shop: the measure, the tolerance, the grid, and the sign-off that the spacing is honest. The product is a local-first Chrome extension: measure records with 10 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 12 active measures; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [Screen Ruler Chrome Extension - Measure, Inspect & Edit the Web](https://www.screen-ruler.com/)
- [GustavoGutierrez/canopy-ruler](https://github.com/GustavoGutierrez/canopy-ruler)
- [Grid Ruler - Chrome Web Store](https://chromewebstore.google.com/detail/grid-ruler/joadogiaiabhmggdifljlpkclnpfncmj)
- [Measuremate — Pixel Ruler for Web Design](https://measuremate.xyz/)

## The wedge (why ours wins)

within a pixel: this build proves it in code (8 readiness points, suite-verified); grid-verified: this build proves it in code (6 readiness points, suite-verified); mobile-first check: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage, activeTab, scripting permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 52 checks, all green.
- Canonical 297-map entry: feature #255 (Studio plan).
...
1. Click the **Screen Ruler** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Screen Ruler today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
