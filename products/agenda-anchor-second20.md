...
_Freemius store product #38565._
...
decision landed: this build proves it in code (8 readiness points, suite-verified); async honesty: this build proves it in code (6 readiness points, suite-verified); short meeting: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #41 (Pro plan).
