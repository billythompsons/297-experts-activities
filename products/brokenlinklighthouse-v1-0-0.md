...
# Broken Link Lighthouse - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Broken link checker. The product is a WordPress plugin with a pure-PHP testable engine, a folk-styled admin report, and a bounded, evidence-first workflow. Fully local: nothing leaves the server.

## What it replaces

- [wordpress.org](https://wordpress.org/plugins/404zen-broken-link-fixer/)
- [en-ca.wordpress.org](https://en-ca.wordpress.org/plugins/broken-link-checker/)

## The wedge (why ours wins)

Bounded queue (12 pages/pass) - the classic Broken Link Checker server-load complaint, designed out; Severity triage (dead vs unreachable vs server-error) instead of one undifferentiated list; Wayback repair suggestion on every dead URL - repair, not just detection; Fully local privacy boundary: no external service, no account, no data leaving the server; Zero signup: works on activation; competitors gate basics behind accounts or upsells
...
2. In the left sidebar, click **Brokenlinklighthouse**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
Broken Link Lighthouse today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
