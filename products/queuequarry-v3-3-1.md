...
# QueueQuarry - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Operational work queues with expiring claims - claimed work with a stale heartbeat returns to open, completions need an outcome, priority bumps need a reason.

_Freemius store product #38506._
...
2. In the left sidebar, click **QueueQuarry**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New queue** - work top to bottom.
...
QueueQuarry today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
