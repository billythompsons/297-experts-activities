...
# TrainingTrail - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Training compliance records: courses with validity windows, completions that require evidence, second-person review (no self-review), exact expiry math, and a renewal review that flags expiring/expired/unreviewed training per person per course.

_Freemius store product #38544._
...
- [T&C Consent Log](https://wordpress.org/plugins/terms-conditions-consent-log/)

## The wedge (why ours wins)

Evidence is mandatory: a completion without an evidence reference is refused by the engine, not flagged later; Review is structural: the trainee can NEVER review their own record; Expiry is real date math (impossible dates rejected at entry), and the renewal review surfaces current / expiring-within-30d / expired / unreviewed per person per course - latest completion supersedes stale ones
...
2. In the left sidebar, click **TrainingTrail**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Courses & people, Record completion** - work top to bottom.
...
TrainingTrail today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
