...
# Route Receipt - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Receipt the trip route: the legs, the buffers, the cost per leg, and the missed-connection plan. The product is a local-first Chrome extension: route records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active routes; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38808._
...
booked: this build proves it in code (8 readiness points, suite-verified); safe buffer: this build proves it in code (6 readiness points, suite-verified); dated: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #258 (Studio plan).
...
1. Click the **Route Receipt** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Route Receipt today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
