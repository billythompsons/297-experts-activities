...
# Schema Sketch - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Sketch the schema before the tables: the entities, the keys, the cardinality, and the migration story. The product is a local-first Chrome extension: sketch records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 15 active sketches; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38816._
...
implemented: this build proves it in code (8 readiness points, suite-verified); indexed: this build proves it in code (6 readiness points, suite-verified); migration path: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 37 checks, all green.
- Canonical 297-map entry: feature #159 (Accelerator plan).
...
1. Click the **Schema Sketch** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Schema Sketch today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
