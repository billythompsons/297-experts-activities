...
# Note Merge - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Merge scattered notes into one story: the sources, the conflicts, and the keeper line that survives. The product is a local-first Chrome extension: merge records with 8 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 20 active merges; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38730._
...
- Canonical 297-map entry: feature #88 (Pro plan).
...
1. Click the **Note Merge** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Note Merge today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
