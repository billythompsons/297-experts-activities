...
# EmployeeRoom - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Internal employee-service records, policy acknowledgements with due dates, and HR service requests - all local to your site.

_Freemius store product #38389._
...
2. In the left sidebar, click **Employeeroom**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
EmployeeRoom today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
