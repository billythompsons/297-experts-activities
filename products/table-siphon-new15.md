...
# Table Siphon - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Siphon the table off the page and into your pipeline: the columns, the rows, the pagination, and the export that lands clean. The product is a local-first Chrome extension: siphon records with 11 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 10 active siphons; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [Table Capture - Chrome Web Store](https://chromewebstore.google.com/detail/table-capture/fcpeoapegiajjakiglehailiihinkhkj)
- [Free Table Capture for Chrome — Repair & Export Without Upload](https://tablecapture.co/)
- [Table to Excel, CSV — For Professionals](https://tabletoexcel.com/)

## The wedge (why ours wins)

multi-page haul: this build proves it in code (8 readiness points, suite-verified); markdown export for docs: this build proves it in code (6 readiness points, suite-verified); clean bill: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage, activeTab, scripting permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Automated suite: 54 checks, all green.
- Canonical 297-map entry: feature #111 (Accelerator plan).
...
1. Click the **Table Siphon** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Table Siphon today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
