...
# Tab Snooze - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Snooze the tab until you need it: the wake time, the reason, and the honest review when it comes back. The product is a local-first Chrome extension: snooze records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 15 active snoozes; Pro (Freemius-licensed, not yet configured) lifts the limit.

## What it replaces

- [Tab Snooze - Chrome Web Store](https://chromewebstore.google.com/detail/tab-snooze/jjleadgffekjlcmhbaamgbpjalhdjfij)
- [TabLater — Snooze Chrome Tabs with Natural Language](https://tablater.com/)
- [Snooze Tabs - Snooze tabs, windows and todos for later](https://snoozetabs.com/)
- [PingLater — Free Tab Snooze Extension for Chrome](https://pinglater.app/)

## The wedge (why ours wins)

reason is specific: this build proves it in code (8 readiness points, suite-verified); first snooze: this build proves it in code (6 readiness points, suite-verified); used on wake: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage, tabs, alarms permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #136 (Accelerator plan).
...
1. Click the **Tab Snooze** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Tab Snooze today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
