...
# ReviewRadar — - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Public-review response planning with approval-first publishing and escalation evidence. Nothing publishes without an explicit approval; triage pins escalated and worst-rated reviews to the top.

_Freemius store product #38513._

## The wedge (why ours wins)

Approval-first response workflow (draft/approved/published), evidence-carrying escalations, triage sorted by escalation + rating, per-platform forward-only intake clock
...
2. In the left sidebar, click **Reviewradar**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
...
ReviewRadar — today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
