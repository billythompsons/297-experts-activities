...
# VendorVault - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Vendor governance: risk-tiered vendor records with enforced review cadences, a grant/revoke ledger of what data each vendor can touch, and contracts whose renewals surface automatically inside a configurable window.

_Freemius store product #38552._

## What it replaces

- [Contract Pilot](https://wordpress.org/plugins/contract-pilot/)
- [DocVault](https://wordpress.org/plugins/trilobita-docvault/)
- [Drawbridge](https://wordpress.org/plugins/folio-drawbridge/)
- [TeamVault](https://wordpress.org/plugins/mikesoft-teamvault/)

## The wedge (why ours wins)

Renewals are computed: every contract within a configurable window surfaces sorted soonest-first, before it silently lapses; Data-sharing reviews are on a clock per vendor, and high-risk vendors are structurally forced into 30-day cycles - policy enforced, not documented; A vendor never reviewed is flagged overdue immediately, not silently OK

## What it does today

- Automated suite: 31 passed, 0 failed.
...
2. In the left sidebar, click **VendorVault**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top cards are the live numbers - **Renewals due (30d), Reviews overdue, High risk, Data grants** - read them left to right for the state of things.
4. The main sections are **Renewals due soon, Vendors, Add vendor, Add contract**. The records table's key columns: Vendor, Risk, Data access, Last review, Actions.
...
VendorVault today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
