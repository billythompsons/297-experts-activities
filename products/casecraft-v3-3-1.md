...
# CaseCraft - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Case studies with enforced evidence: challenge and approach must be real sentences, results must carry a typed metric (percent/currency/count/days) with a label. Shortcode [casecraft].

_Freemius store product #38344._
...
2. In the left sidebar, click **CaseCraft**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Add study**. The records table's key columns: Client, Study, Result.
...
CaseCraft today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
