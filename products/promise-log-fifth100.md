...
# Promise Log - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Log every promise you make: to whom, by when, the delivery proof, and the kept rate. The product is a local-first Chrome extension: promise records with 7 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 25 active promises; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38752._
...
kept: this build proves it in code (8 readiness points, suite-verified); proven: this build proves it in code (6 readiness points, suite-verified); repaired: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #91 (Pro plan).
...
1. Click the **Promise Log** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Promise Log today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
