...
# ConsentCanvas - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Consent coverage audit: inventory tracked scripts, map each non-essential one to a consent category, and see your coverage percent - unmapped scripts are named as compliance leaks. Pairs with ConsentBeacon (which enforces at runtime).

_Freemius store product #38358._
...
2. In the left sidebar, click **ConsentCanvas**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **Inventory a script**. The records table's key columns: Handle, URL, Status, Map to.
...
ConsentCanvas today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
