...
# CommunityForge - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Lightweight community boards: topics with anti-spam guards (length + link limits), replies, and moderation where 3 distinct member reports auto-hide a topic. Shortcode [communityforge board="slug"].

_Freemius store product #38354._
...
2. In the left sidebar, click **CommunityForge**. The folk-styled admin page opens: paper background, eyebrow line, serif-italic headline.
3. The top of the page carries the live summary - read it left to right for the state of things.
4. The main sections are **New board**. The records table's key columns: Board, Slug, Topics, Hidden, New topic.
...
CommunityForge today carries 0 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
