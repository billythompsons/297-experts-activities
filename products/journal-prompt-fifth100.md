...
# Journal Prompt - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

The prompt that opens the page A daily nudge worth answering.

_Freemius store product #38694._
...
- Canonical 297-map entry: feature #297 (Studio plan).
...
1. Click the **Journal Prompt** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Journal Prompt today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
