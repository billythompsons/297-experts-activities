...
# Purchase Brief - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Brief it before you buy it The need, the research, the wait.

_Freemius store product #38755._
...
PurchaseBrief is a matrix that understands money: must-have knockouts that kill options regardless of score, and cost per year instead of sticker price. The output is the decision record - "why we chose it" - not just a ranking

## What it does today

- Automated suite: 24 passed, 0 failed.
- Canonical 297-map entry: feature #295 (Studio plan).
...
1. Click the **Purchase Brief** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
Purchase Brief today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
