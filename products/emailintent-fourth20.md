...
# EmailIntent - 297 in 501: Experts Activities

![The five plans, one ladder](tier-ladder.png)

## What it is

Name the intent before you write the email: one ask, one tone, one next step. The product is a local-first Chrome extension: email draft records with 9 domain fields, a 4-gate quality workflow, readiness scoring, milestones, and exportable artifacts. Free plan: 15 active email drafts; Pro (Freemius-licensed, not yet configured) lifts the limit.

_Freemius store product #38650._
...
ask appears in the draft: this build proves it in code (8 readiness points, suite-verified); reply deadline set: this build proves it in code (6 readiness points, suite-verified); short draft: this build proves it in code (6 readiness points, suite-verified); Local-first privacy boundary: only storage permission; competitors route through their cloud; Zero signup: works on install; the competitors above gate basic use behind accounts
...
- Canonical 297-map entry: feature #66 (Pro plan).
...
1. Click the **EmailIntent** icon in the Chrome toolbar (top right, puzzle-piece menu if pinned away).
...
EmailIntent today carries 1 of the 297 canonically. The vision is every product carrying all 297. For each feature this product does not yet ship: what to build, how, and what it needs (free tiers and open source first, per the standing rule).
